...
// Control signals:
// Sinais de controle:
//   reg_write  : enables write to the register file
//   reg_write  : habilita escrita no banco de registradores
//   alu_src_a  : selects ALU operand A (0=rs1, 1=PC)
//   alu_src_a  : seleciona operando A da ALU (0=rs1, 1=PC)
//   alu_src_b  : selects ALU operand B (0=rs2, 1=immediate)
...
//   jump       : JAL instruction
//   jump       : instrução JAL
//   jump_r     : JALR instruction
//   jump_r     : instrução JALR
//   mem_to_reg : selects data to write to register
...
//   alu_op     : code for the ALU control unit
    ...
    always_comb begin
        ...
        case (opcode)
            ...
            OP_LUI: begin
                reg_write  = 1'b1;
                alu_src_b  = 1'b1;
                mem_to_reg = 2'b11;  // direct immediate → rd / imediato direto → rd
            end
