...
#   Toggle bit 1: inverte o bit 1
#
# Técnicas:
#   Set   bit N → x = x | (1 << N)     — OR com máscara de 1 bit
#   Clear bit N → x = x & ~(1 << N)    — AND com máscara invertida
#   Toggle bit N → x = x ^ (1 << N)    — XOR com máscara de 1 bit
#
# Cálculo:
#   x1 = 0b10101010
#
...
_start:
    ...
    xori  x5, x5, -1           # x5 = ~x5 = 0b...01111111  (XOR com todos 1s = NOT)
