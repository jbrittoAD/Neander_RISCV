...
// =============================================================================
module unified_mem #(
    parameter DEPTH = 4096,   // Palavras de 32 bits
    ...
    // Índices de palavra (12 bits para DEPTH=4096)
    wire [AW-1:0] iidx = instr_addr[AW+1:2];  // Instrução
    wire [AW-1:0] didx = data_addr[AW+1:2];    // Dado
    wire [1:0]    boff = data_addr[1:0];        // Byte offset do dado
